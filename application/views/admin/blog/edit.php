<div class="row">
  <div class="col-lg">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="<?= base_url('admin/Blog/update/').$blog['id_blog'] ?>" enctype="multipart/form-data">
        <div class="row">
          <div class="col-lg-8">
            <div class="form-group">
              <textarea required="" id="ckeditor" name="blog_isi" required><?= $blog['blog_isi'] ?></textarea>
            </div>
          </div>  
          <div class="col-lg-4">
            <div class="form-group">
              <label for="judul">Judul Blog</label>
              <input required="" name="blog_title" value="<?= $blog['blog_title'] ?>" id="judul" class="form-control" placeholder="">
            </div>
            <div class="form-group">
